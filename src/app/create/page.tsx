...
const Page = () => {
    ...
    const handleSubmit = async (e: any) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost/api/location', {
            ...
            <div className='lg:w-1/2 h-full p-[1.5rem]'>
                <div className=' border-gray-300 border bg-gray-100 shadow-lg rounded-lg p-6'>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
                            <label htmlFor="lat" className="block text-sm font-medium text-gray-700">Address</label>
                        ...
                        <div className="mb-4">
                            <label htmlFor="lat" className="block text-sm font-medium text-gray-700">Description</label>
                        ...
                        <div className="mb-4">
                            <label htmlFor="lat" className="block text-sm font-medium text-gray-700">Category</label>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="file" id="image" name="image" onChange={handleImageChange} accept="image/*" className="mt-1 p-2 block w-full border-gray-300 rounded-md focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" />
                        </div>
                        <button type="submit" className="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-md">Create</button>
                    </form>
                </div>
            </div>

            <div className='lg:w-1/2 h-[105.5vh] p-[1.5rem]'>
                    <Map />
            </div>
